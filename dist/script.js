...
const modals = () => {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    let closeClickOvelay = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
    ...
    modal.addEventListener('click', e => {
      if (e.target === modal && closeClickOvelay) {
        modal.style.display = "none";
        document.body.style.overflow = "";
        document.body.style.marginRight = `0px`;
...
/* harmony import */ var _modules_validateForms__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/validateForms */ "./src/js/modules/validateForms.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_validateForms__WEBPACK_IMPORTED_MODULE_7__["default"])();
